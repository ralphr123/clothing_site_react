    ...
    return (
        <div className="footer-container center">
            <div className="footer center-horizontal">
                ...
                <div className="footer-group">
                    <span className="footer-title unselectable">CUSTOMERS</span> <br/>
                ...
                <div className="footer-group">
                    <span className="footer-title unselectable">COMPANY</span> <br/>
                ...
                <div className="footer-group">
                    <span className="footer-title unselectable">COMMUNITY</span> <br/>
